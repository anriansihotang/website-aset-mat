...
<html lang="en">
  ...
  <body>
	...
	<h1 class="text-center py-3">Data Kendaraan</h1>
		<div class="container-fluid">
		<table class="table">
  <thead>
    <tr>
  ...
  <?php 
  require_once './controller/datakendaraan.php';
  $query = "SELECT * FROM crudkendaraan ORDER BY th_beli DESC";
  
  if($_SESSION['hak_akses'] == 'user'){
    $aset->Tampilkendaraan($query);
  }
  else if($_SESSION['hak_akses'] == 'admin'){
      $aset->Tampiladminkendaraan($query);
  }
  ?>
  </tbody>
	</main>
	...
	<main>
			<h1 class="text-center my-4">Data Kendaraan</h1>
		</main>
		<h1>admin</h1>
	<?php
		}
