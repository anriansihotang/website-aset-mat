...
<html lang="en">
  ...
  <body>
	...
	<h1 class="text-center py-3">Data Furnitur</h1>
		<div class="container-fluid">
		<table class="table">
  <thead>
    <tr>
  ...
  <?php 
  require_once './controller/datafurnitur.php';
  $query = "SELECT * FROM crudfurnitur ORDER BY id DESC";
  ...
  ?>
	...
	<main>
			<h1 class="text-center my-4">Data Furnitur</h1>
		</main>
		<h1>admin</h1>
	<?php
		}
